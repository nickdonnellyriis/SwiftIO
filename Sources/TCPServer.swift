...
public class TCPServer {
    ...
    private let queue = DispatchQueue(label: "io.schwa.TCPServer", attributes: DispatchQueueAttributes.serial)
    ...
    private func startListening(_ address: Address) throws {
